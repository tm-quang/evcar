...
import { createMaintenance, deleteMaintenance, updateVehicle, type VehicleRecord } from '../../lib/ev/vehicleService'
                            ...
                            <div className="relative z-10">
                                <div className="mb-4 flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black uppercase tracking-widest opacity-70">Tổng quan</p>
                                            <p className="text-sm font-bold">Bản ghi bảo dưỡng</p>
                                        </div>
                                    </div>
                                    <span className="rounded-full bg-white/10 border border-white/20 px-3 py-1 text-[10px] font-black uppercase tracking-wider">{isMoto ? 'Xe máy' : 'Ô tô'} • {selectedVehicle.license_plate}</span>
                                </div>
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="border-r border-white/10 pr-4">
                                        <p className="text-sm opacity-70 mb-0.5">Lần thực hiện</p>
                                        <p className="text-3xl font-black">{logs.length}</p>
                                    </div>
                                    <div className="pl-4">
                                        <p className="text-sm opacity-70 mb-0.5">Tổng chi phí</p>
