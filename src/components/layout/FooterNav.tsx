      ...
      <div className="relative w-full max-w-md pointer-events-auto">
        ...
        <div className="absolute left-1/2 bottom-[12px] z-30 -translate-x-1/2">
          <button
            ...
            className={`group flex h-14 w-14 items-center justify-center rounded-full shadow-xl transition-all hover:scale-110 hover:shadow-2xl active:scale-95 ${
              isDarkMode
        ...
        <div className="relative h-[100px]">
          ...
          <div className="absolute bottom-0 w-full h-[105px] drop-shadow-[0_-10px_30px_rgba(0,0,0,0.08)]">
            <svg
              viewBox="0 0 400 100"
            ...
            >
              ...
              />
              {/* Top border line for dark mode visibility */}
              {isDarkMode && (
                <path
                  d="M 0,60 
                     C 0,48.954 8.954,40 20,40 
                ...
                >
                  <span
                    className={`flex h-9 w-9 items-center justify-center rounded-full text-lg transition-all ${
                      active
                        ? isDarkMode
                          ? 'bg-blue-500/20 text-blue-400 shadow-md shadow-blue-500/10'
